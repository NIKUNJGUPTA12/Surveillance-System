...
def contact():
    mess._show(title='Contact us', message="Please contact us on : 'cse20801@glbitm.ac.in' ")
...
window.title("Survilliance System")
...
message3 = tk.Label(window, text="Survilliance System" ,fg="white",bg="#262523" ,width=55 ,height=1,font=('times', 29, ' bold '))
